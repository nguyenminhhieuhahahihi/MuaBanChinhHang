...
class Login extends React.Component {
  ...
  onSubmitLogin = (event) => {
    ...
    if (account === "") {
      ...
      alert(
        "your account has been banned, contact Foodieblog for more details"
      );
        ...
        <div className="signin__content">
          ...
          <div className="signin__form">
            <ul
              ...
              role="tablist"
              onClick={this.onToggleSignIn}
            >
              <li className="nav-item">
                <p
                  className={
                    isDisplay === true ? "nav-link active" : "nav-link"
                  }
                >
                  Sign in
                </p>
              ...
              <li className="nav-item">
                <p
                  className={
                    isDisplay === false ? "nav-link active" : "nav-link"
                  }
                >
                  Sign up
                </p>
            ...
            <div className="tab-content">
              <div
                className={
                  isDisplay === false ? " tab-pane" : " active tab-pane"
                }
                id="tabs-1"
                role="tabpanel"
              >
